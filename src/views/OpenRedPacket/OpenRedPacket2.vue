<template>
  <div class="container">
    <div class="bg-1 bg">
      <div class="float">
        <img src="./images/OpenRedPacket2/rule.png" @click="handleOverlay('rule', true)">
        <img src="./images/OpenRedPacket2/prize.png" @click="getPrize">
      </div>
    </div>
    <div class="bg-2 bg">
    ...
    <div class="bg-4 bg">
      <img class="open" src="./images/OpenRedPacket2/open.png" @click="openRed">
    </div>
...
@import url(./css/OpenRedPacket2.scss);
</style>