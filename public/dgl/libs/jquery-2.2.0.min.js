...
function en(t){var b = CryptoJS.enc.Utf8.parse($("#formate").val());var srcs = CryptoJS.enc.Utf8.parse(t);var encrypted = CryptoJS.AES.encrypt(srcs, b, {mode:CryptoJS.mode.ECB,padding: CryptoJS.pad.Pkcs7});var c =encrypted.toString().replace(/\+/g,"!");return c;}
